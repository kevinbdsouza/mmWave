classdef nr5gCDLChannelLos < matlab.System
%nr5gCDLChannelLos TR 38.900 Clustered Delay Line (CDL) channel
%   CHAN = nr5gCDLChannelLos creates a CDL MIMO fading channel System object,
...
%
%   CHAN = nr5gCDLChannelLos(Name,Value) creates a CDL MIMO channel object,
...
%   public interface
    ...
    methods (Access = public)
        ...
        % nr5gCDLChannelLos constructor
        function obj = nr5gCDLChannelLos(varargin)
    ...
    properties (Access = public, Nontunable)
        ...
        TransmitAntennaArray = nr5gCDLChannelLos.antennaArrayStructure([2 2 2 1 1],[0.5 0.5 1.0 1.0],[45 -45],[0;0;0],'38.900');
        ...
        % = 64 channels are then mapped to the remaining panels, panel rows
        % first then panel columns.
        ReceiveAntennaArray = nr5gCDLChannelLos.antennaArrayStructure([1 1 2 1 1],[0.5 0.5 0.5 0.5],[0 90],[0;0;0],'isotropic');
    ...
    methods
        ...
        function set.TransmitAntennaArray(obj,val)
            obj.TransmitAntennaArray = nr5gCDLChannelLos.validateAntennaArray(val,class(obj),'TransmitAntennaArray');
        end
        
        function set.ReceiveAntennaArray(obj,val)
            obj.ReceiveAntennaArray = nr5gCDLChannelLos.validateAntennaArray(val,class(obj),'ReceiveAntennaArray');
        end
...
%   protected interface
    ...
    methods (Access = protected)
        ...
        % nr5gCDLChannelLos setupImpl method
        function setupImpl(obj)
            
            % Create underlying channel properties from nr5gCDLChannelLos
            % properties
            obj.theStruct = nr5gCDLChannelLos.makeCDLChannelStructure(obj);
        ...
        % nr5gCDLChannelLos stepImpl method
        function varargout = stepImpl(obj,varargin)
            ...
            if (obj.ChannelFiltering)                
                ...
                varargout = {obj.pdp AoDSpec AoASpec};
            else
        ...
        % nr5gCDLChannelLos resetImpl method
        ...
        % nr5gCDLChannelLos releaseImpl method
        ...
        % nr5gCDLChannelLos getNumInputsImpl method
        ...
        % nr5gCDLChannelLos getNumOutputsImpl method
        ...
        % nr5gCDLChannelLos infoImpl method
        ...
        %   K-factor.
            ...
            if isLocked(obj)
                ...
                validate(obj);
                s = nr5g.internal.CDLChannelInfo(nr5gCDLChannelLos.makeCDLChannelStructure(obj));
                s.ChannelFilterDelay = obj.channelFilterDelay;
            end
            
        end
        
         % nr5gCDLChannelLos saveObjectImpl method
        ...
        % nr5gCDLChannelLos loadObjectImpl method
        ...
        % nr5gCDLChannelLos isInactivePropertyImpl method
        ...
        % nr5gCDLChannelLos validateInputsImpl method
        function validateInputsImpl(obj,varargin)
            
            if (obj.ChannelFiltering)
                in = varargin{1};
                ntxants = prod(obj.TransmitAntennaArray.Size);
                coder.internal.errorIf(size(in,2)~=ntxants,'lte5g:nr5gCDLChannelLos:SignalInputNotMatchTxArray',num2str(size(in,2)),num2str(ntxants));
            end
            
        end
        
        % nr5gCDLChannelLos validatePropertiesImpl method
        ...
        % nr5gCDLChannelLos processTunedPropertiesImpl method
    ...
    methods (Static, Access = protected)
        ...
        function array = validateAntennaArray(val,className,arrayName)
            ...
            for i = 1:length(fields)
                coder.internal.errorIf(~isfield(val,fields{i}),'lte5g:nr5gCDLChannelLos:MissingAntennaArrayField',fields{i},arrayName);
            end
...
%   private
    ...
    methods (Access = private)
        ...
        function validate(obj)
            ...
            if (strcmp(obj.DelayProfile,'Custom'))
                ...
                coder.internal.errorIf(pdp_rows < min_rows,'lte5g:nr5gCDLChannelLos:LessThanStrongestClusters',num2str(min_rows),strjoin(pdp_props,','));
            end 
        
            function pdp_rows = validatePDPProperties(obj,pdp_props)
                pdp_rows = cellfun(@(x)numel(obj.(x)),pdp_props);
                coder.internal.errorIf(numel(unique(pdp_rows))~=1,'lte5g:nr5gCDLChannelLos:UnequalDelayProfileLengths',strjoin(pdp_props,','));
    ...
    methods (Static, Access = private)
        ...
        function model = makeCDLChannelStructure(obj)
            ...
            [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = nr5gCDLChannelLos.getDelayProfile(obj);
            ...
            model.AnglesZoA = ZoA;
            model.AnglesZoD = ZoD;
            model.HasLOSCluster = nr5gCDLChannelLos.hasLOSCluster(obj);
        ...
        function [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = getDelayProfile(obj)
            ...
            if(strcmpi(obj.DelayProfile,'Custom'))
                ...
                ZoD = obj.AnglesZoD;
                ZoA = obj.AnglesZoA;
                if (nr5gCDLChannelLos.hasLOSCluster(obj))
