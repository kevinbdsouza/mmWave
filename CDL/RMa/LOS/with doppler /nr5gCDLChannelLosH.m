classdef nr5gCDLChannelLosH < matlab.System   
%nr5gCDLChannelLosH TR 38.900 Clustered Delay Line (CDL) channel
%   CHAN = nr5gCDLChannelLosH creates a CDL MIMO fading channel System object,
...
%
%   CHAN = nr5gCDLChannelLosH(Name,Value) creates a CDL MIMO channel object,
...
%   public interface
    ...
    methods (Access = public)
        ...
        % nr5gCDLChannelLosH constructor
        function obj = nr5gCDLChannelLosH(varargin)
    ...
    properties (Access = public, Nontunable)
        ...
        TransmitAntennaArray = nr5gCDLChannelLosH.antennaArrayStructure([2 2 2 1 1],[0.5 0.5 1.0 1.0],[45 -45],[0;0;0],'38.900');
        ...
        % = 64 channels are then mapped to the remaining panels, panel rows
        % first then panel columns.
        ReceiveAntennaArray = nr5gCDLChannelLosH.antennaArrayStructure([1 1 2 1 1],[0.5 0.5 0.5 0.5],[0 90],[0;0;0],'isotropic');
    ...
    methods
        ...
        function set.TransmitAntennaArray(obj,val)
            obj.TransmitAntennaArray = nr5gCDLChannelLosH.validateAntennaArray(val,class(obj),'TransmitAntennaArray');
        end
        
        function set.ReceiveAntennaArray(obj,val)
            obj.ReceiveAntennaArray = nr5gCDLChannelLosH.validateAntennaArray(val,class(obj),'ReceiveAntennaArray');
        end
...
%   protected interface
    ...
    methods (Access = protected)
        ...
        % nr5gCDLChannelLosH setupImpl method
        function setupImpl(obj)
            
            % Create underlying channel properties from nr5gCDLChannelLosH
            % properties
            obj.theStruct = nr5gCDLChannelLosH.makeCDLChannelStructure(obj);
        ...
        % nr5gCDLChannelLosH stepImpl method
        function varargout = stepImpl(obj,varargin)
            ...
            [pathgains,sampletimes,AoDSpec,AoASpec] = CDLChannelLos(obj.theStruct,obj.theInfo,obj.pdp,insize,obj.rayCoupling,obj.initialPhases);
            ...
            if (obj.ChannelFiltering)                
                ...
                varargout = {pathgains AoDSpec AoASpec};
            else
        ...
        % nr5gCDLChannelLosH resetImpl method
        ...
        % nr5gCDLChannelLosH releaseImpl method
        ...
        % nr5gCDLChannelLosH getNumInputsImpl method
        ...
        % nr5gCDLChannelLosH getNumOutputsImpl method
        ...
        % nr5gCDLChannelLosH infoImpl method
        ...
        %   K-factor.
            ...
            if isLocked(obj)
                ...
                validate(obj);
                s = nr5g.internal.CDLChannelInfo(nr5gCDLChannelLosH.makeCDLChannelStructure(obj));
                s.ChannelFilterDelay = obj.channelFilterDelay;
            end
            
        end
        
         % nr5gCDLChannelLosH saveObjectImpl method
        ...
        % nr5gCDLChannelLosH loadObjectImpl method
        ...
        % nr5gCDLChannelLosH isInactivePropertyImpl method
        ...
        % nr5gCDLChannelLosH validateInputsImpl method
        function validateInputsImpl(obj,varargin)
            
            if (obj.ChannelFiltering)
                in = varargin{1};
                ntxants = prod(obj.TransmitAntennaArray.Size);
                coder.internal.errorIf(size(in,2)~=ntxants,'lte5g:nr5gCDLChannelLosH:SignalInputNotMatchTxArray',num2str(size(in,2)),num2str(ntxants));
            end
            
        end
        
        % nr5gCDLChannelLosH validatePropertiesImpl method
        ...
        % nr5gCDLChannelLosH processTunedPropertiesImpl method
    ...
    methods (Static, Access = protected)
        ...
        function array = validateAntennaArray(val,className,arrayName)
            ...
            for i = 1:length(fields)
                coder.internal.errorIf(~isfield(val,fields{i}),'lte5g:nr5gCDLChannelLosH:MissingAntennaArrayField',fields{i},arrayName);
            end
...
%   private
    ...
    methods (Access = private)
        ...
        function validate(obj)
            ...
            if (strcmp(obj.DelayProfile,'Custom'))
                ...
                coder.internal.errorIf(pdp_rows < min_rows,'lte5g:nr5gCDLChannelLosH:LessThanStrongestClusters',num2str(min_rows),strjoin(pdp_props,','));
            end 
        
            function pdp_rows = validatePDPProperties(obj,pdp_props)
                pdp_rows = cellfun(@(x)numel(obj.(x)),pdp_props);
                coder.internal.errorIf(numel(unique(pdp_rows))~=1,'lte5g:nr5gCDLChannelLosH:UnequalDelayProfileLengths',strjoin(pdp_props,','));
    ...
    methods (Static, Access = private)
        ...
        function model = makeCDLChannelStructure(obj)
            ...
            [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = nr5gCDLChannelLosH.getDelayProfile(obj);
            ...
            model.AnglesZoA = ZoA;
            model.AnglesZoD = ZoD;
            model.HasLOSCluster = nr5gCDLChannelLosH.hasLOSCluster(obj);
        ...
        function [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = getDelayProfile(obj)
            ...
            if(strcmpi(obj.DelayProfile,'Custom'))
                ...
                ZoD = obj.AnglesZoD;
                ZoA = obj.AnglesZoA;
                if (nr5gCDLChannelLosH.hasLOSCluster(obj))
