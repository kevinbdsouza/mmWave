classdef nr5gCDLChannelNlosH < matlab.System
%nr5gCDLChannelNlosH TR 38.900 Clustered Delay Line (CDL) channel
%   CHAN = nr5gCDLChannelNlosH creates a CDL MIMO fading channel System object,
...
%
%   CHAN = nr5gCDLChannelNlosH(Name,Value) creates a CDL MIMO channel object,
...
%
%   nr5gCDLChannelNlosH properties:
%
...
%   public interface
    ...
    methods (Access = public)
        ...
        % nr5gCDLChannelNlosH constructor
        function obj = nr5gCDLChannelNlosH(varargin)
    ...
    properties (Access = public, Nontunable)
        ...
        TransmitAntennaArray = nr5gCDLChannelNlosH.antennaArrayStructure([2 2 2 1 1],[0.5 0.5 1.0 1.0],[45 -45],[0;0;0],'38.900');
        ...
        % = 64 channels are then mapped to the remaining panels, panel rows
        % first then panel columns.
        ReceiveAntennaArray = nr5gCDLChannelNlosH.antennaArrayStructure([1 1 2 1 1],[0.5 0.5 0.5 0.5],[0 90],[0;0;0],'isotropic');
    ...
    methods
        ...
        function set.TransmitAntennaArray(obj,val)
            obj.TransmitAntennaArray = nr5gCDLChannelNlosH.validateAntennaArray(val,class(obj),'TransmitAntennaArray');
        end
        
        function set.ReceiveAntennaArray(obj,val)
            obj.ReceiveAntennaArray = nr5gCDLChannelNlosH.validateAntennaArray(val,class(obj),'ReceiveAntennaArray');
        end
...
%   protected interface
    ...
    methods (Access = protected)
        ...
        % nr5gCDLChannelNlosH setupImpl method
        function setupImpl(obj)
            
            % Create underlying channel properties from nr5gCDLChannelNlosH
            % properties
            obj.theStruct = nr5gCDLChannelNlosH.makeCDLChannelStructure(obj);
        ...
        % nr5gCDLChannelNlosH stepImpl method
        function varargout = stepImpl(obj,varargin)
            ...
            if (obj.ChannelFiltering)                
                ...
                varargout = {pathgains pdpType AoDSpec};
            else
        ...
        % nr5gCDLChannelNlosH resetImpl method
        ...
        % nr5gCDLChannelNlosH releaseImpl method
        ...
        % nr5gCDLChannelNlosH getNumInputsImpl method
        ...
        % nr5gCDLChannelNlosH getNumOutputsImpl method
        ...
        % nr5gCDLChannelNlosH infoImpl method
        ...
        %   K-factor.
            ...
            if isLocked(obj)
                ...
                validate(obj);
                s = nr5g.internal.CDLChannelInfo(nr5gCDLChannelNlosH.makeCDLChannelStructure(obj));
                s.ChannelFilterDelay = obj.channelFilterDelay;
            end
            
        end
        
         % nr5gCDLChannelNlosH saveObjectImpl method
        ...
        % nr5gCDLChannelNlosH loadObjectImpl method
        ...
        % nr5gCDLChannelNlosH isInactivePropertyImpl method
        ...
        % nr5gCDLChannelNlosH validateInputsImpl method
        function validateInputsImpl(obj,varargin)
            
            if (obj.ChannelFiltering)
                in = varargin{1};
                ntxants = prod(obj.TransmitAntennaArray.Size);
                coder.internal.errorIf(size(in,2)~=ntxants,'lte5g:nr5gCDLChannelNlosH:SignalInputNotMatchTxArray',num2str(size(in,2)),num2str(ntxants));
            end
            
        end
        
        % nr5gCDLChannelNlosH validatePropertiesImpl method
        ...
        % nr5gCDLChannelNlosH processTunedPropertiesImpl method
    ...
    methods (Static, Access = protected)
        ...
        function array = validateAntennaArray(val,className,arrayName)
            ...
            for i = 1:length(fields)
                coder.internal.errorIf(~isfield(val,fields{i}),'lte5g:nr5gCDLChannelNlosH:MissingAntennaArrayField',fields{i},arrayName);
            end
...
%   private
    ...
    methods (Access = private)
        ...
        function validate(obj)
            ...
            if (strcmp(obj.DelayProfile,'Custom'))
                ...
                coder.internal.errorIf(pdp_rows < min_rows,'lte5g:nr5gCDLChannelNlosH:LessThanStrongestClusters',num2str(min_rows),strjoin(pdp_props,','));
            end 
        
            function pdp_rows = validatePDPProperties(obj,pdp_props)
                pdp_rows = cellfun(@(x)numel(obj.(x)),pdp_props);
                coder.internal.errorIf(numel(unique(pdp_rows))~=1,'lte5g:nr5gCDLChannelNlosH:UnequalDelayProfileLengths',strjoin(pdp_props,','));
    ...
    methods (Static, Access = private)
        ...
        function model = makeCDLChannelStructure(obj)
            ...
            [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = nr5gCDLChannelNlosH.getDelayProfile(obj);
            ...
            model.AnglesZoA = ZoA;
            model.AnglesZoD = ZoD;
            model.HasLOSCluster = nr5gCDLChannelNlosH.hasLOSCluster(obj);
        ...
        function [pathDelays,pathGains,AoD,AoA,ZoD,ZoA] = getDelayProfile(obj)
            ...
            if(strcmpi(obj.DelayProfile,'Custom'))
                ...
                ZoD = obj.AnglesZoD;
                ZoA = obj.AnglesZoA;
                if (nr5gCDLChannelNlosH.hasLOSCluster(obj))
