...
% First, we set up the simulation parameters. Note the sample density of 2.5 which enables very fast
% simulations even with drifting.
...
% Next, we generate the channel coefficients. Note that here, the initial sample density is 2.5. We
...
% interpolated values (blue line) have 5 times as many sample points.
