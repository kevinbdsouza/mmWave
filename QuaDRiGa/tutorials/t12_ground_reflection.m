...
l.track = qd_track( 'linear' , 50, 0 );                 % 50 m long track
l.track.initial_position = [10 ; 0 ; 1.5 ];             % Set start positions and MT height
l.track.interpolate_positions(10);                      % Set sampling rate to 10 saples per meter

% Each of the 3 BS gets assigned a different scenario:
l.track.scenario = { 'TwoRayGR' ; '3GPP_38.901_UMi_LOS' ; '3GPP_38.901_UMi_LOS_GR' };

l.track.split_segment;                                  % Split into segments
