...
l.track = copy( t );                                    % Set the rx-track
l.track.correct_overlap;                                % Adjust state change position
...
lnk = [l.tx_position,l.track.positions(:,l.track.segment_index(2))+l.track.initial_position ];
